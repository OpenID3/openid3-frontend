...
import { Chain, UserOperationStruct, genUserOp, genUserOpHash, getWeb3Provider, updateGasEstimation } from "./userop";
...
export async function updateSignatureWithProof(
